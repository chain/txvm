...
func OnFinalize(h ...func(*VM)) Option {
	return func(vm *VM) {
		vm.onFinalize = append(vm.onFinalize, h...)
	}
}
...
func BeforeStep(h ...func(*VM)) Option {
	return func(vm *VM) {
		vm.beforeStep = append(vm.beforeStep, h...)
	}
}
...
func AfterStep(h ...func(*VM)) Option {
	return func(vm *VM) {
		vm.afterStep = append(vm.afterStep, h...)
	}
}
